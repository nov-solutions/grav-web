...
export const Nav = () => {
  ...
  return (
    <nav className={`fixed w-screen sm:w-full px-8 z-30 backdrop-blur-md bg-black/25 items-center transition-transform duration-300 ${
      navVisible ? 'translate-y-0' : '-translate-y-full' 
    }`}>
      <div className="py-6 flex mx-auto justify-between gap-4 sm:gap-8 w-full max-w-screen-2xl">
