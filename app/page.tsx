...
export default function Home() {
  return (
    <>
      ...
      <section id="portfolio" className="py-6 sm:py-12 w-full max-w-screen-xl space-y-12 px-8">
      ...
      <section id="founders" className="py-6 sm:py-12 w-full max-w-screen-xl space-y-12 px-8">
